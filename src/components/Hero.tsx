    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-20">
        <div className="max-w-4xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/20 bg-card shadow-sm mb-8 animate-fade-in">
            <span className="w-2 h-2 rounded-full bg-primary animate-pulse" />
            <span className="text-sm text-primary font-medium">Now Open for Orders</span>
          </div>

          {/* Title */}
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-semibold text-foreground mb-4 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            <span className="text-gradient">Flavvora</span>
          </h1>
          
          <p className="font-display text-xl md:text-2xl text-muted-foreground italic mb-6 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Savor the Flavor
          </p>

          <p className="text-base md:text-lg text-foreground/70 max-w-2xl mx-auto mb-10 animate-fade-in leading-relaxed" style={{ animationDelay: "0.3s" }}>
